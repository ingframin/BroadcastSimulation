...
##        plt.hist(h,density=True,histtype='step',align='left',rwidth=0.8)
    xy = plt.hist(h_xy[0],bins = 11,density=True,histtype='step',align='left',rwidth=0.8)
    xy2 = plt.hist(h_xy[1],bins = 11,density=True,histtype='step',align='left',rwidth=0.8)
    plt.close()
